...
def save(player):
    sql = "INSERT INTO players( user_player, name,image,nationality,nationality_image,overall,height,weight, preferred_foot,birth_date,age,position,kit_number,positioning,diving,handling,kicking,reflexes,reactions,composure,slide_tackle,stand_tackle,aggression,interceptions,strength,balance,jumping,heading,ball_control,vision, crossing,short_pass,long_pass, stamina,agility,long_shot,dribbling,at_positioning,sprint_speed,shot_power,finishing,fk_accuracy,penalties,volleys,team_id ) VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s , %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) RETURNING id"
